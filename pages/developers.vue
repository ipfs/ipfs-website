<template>
  <div>
    ...
    />
    <Hero background="developers-hero.jpg">
      <template #title>
    ...
    <PageSection>
      ...
      <Grid>
        <Card background="light" button-label="Check it out" button-link="#" center>
          <UnLazyImage src="/images/logo-opera.png" class="mb-8 h-32 w-full object-contain object-center" />
        ...
        <Card background="light" button-label="Check it out" button-link="#" center>
          <UnLazyImage src="/images/logo-chrome.png" class="mb-8 h-32 w-full object-contain object-center" />
          <h3 class="mb-8 text-xl">
            Chromium Extensions
          </h3>
          <p class="mb-8 text-2xl">
        ...
        <Card background="light" button-label="Check it out" button-link="#" center>
          <UnLazyImage src="/images/logo-firefox.png" class="mb-8 h-32 w-full object-contain object-center" />
          <h3 class="mb-8 text-xl">
            Firefox Extension
          </h3>
          <p class="mb-8 text-2xl">
