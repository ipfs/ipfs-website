        ...
        <div class="grid grid-cols-12 p-4 mt-4 gap-y-0 sm:gap-y-24">
          ...
          >
            ...
            <div class="flex justify-center sm:justify-start">
              <Button
                href="https://docs.ipfs.eth.link/install/ipfs-desktop/"
                target="_blank"
                rel="noopener"
          ...
          >
            <h4 class="text-xl md:text-2xl mb-1.5">
              <Link
                class="text-blueGreenLight font-display hover:underline"
                :item="{
                  link: 'https://docs.ipfs.eth.link/how-to/command-line-quick-start',
            ...
            <div class="flex justify-center sm:justify-start">
              <Button
                href="https://docs.ipfs.eth.link/how-to/command-line-quick-start"
                target="_blank"
                rel="noopener"
          ...
          >
            ...
            >
              ...
              <div class="flex justify-center sm:justify-start">
                <Button
                  href="https://docs.ipfs.eth.link/install/ipfs-companion/"
                  target="_blank"
                  rel="noopener"
          ...
          <div class="pl-0 sm:pl-10">
            <p class="leading-normal">
              ...
              <Link
                class="text-blueGreen font-bold hover:underline"
                :item="{
                  link: 'https://docs.ipfs.eth.link/concepts/persistence/',
                  text: 'pin content',
                }"
                :on-click="
          ...
          <div class="pl-0 sm:pl-10">
            <p class="leading-normal">
              ...
              <Link
                class="text-blueGreen font-bold hover:underline"
                :item="{
                  link: 'https://docs.ipfs.eth.link/concepts/ipns/',
                  text: 'IPNS',
                }"
                :on-click="
              ...
              <Link
                class="text-blueGreen font-bold hover:underline"
                :item="{
                  link: 'https://docs.ipfs.eth.link/concepts/dnslink/',
                  text: 'DNSLink',
                }"
                :on-click="
                  (item) => onCTAClick({ ui: 'how/1-performance', ...item })
