<template>
  <div>
    ...
    <PageSection tight>
      <Grid>
        <Card background="light" button-label="Read their story" button-link="https://blog.ipfs.tech/2022-11-15-3s-studio/" center>
          <UnLazyImage src="/images/logo-3S.png" class="mb-8 h-32 w-full object-contain object-center" />
        ...
        <Card background="light" button-label="Read their story" button-link="https://youtu.be/K2zVNcn6CIU" center>
          <UnLazyImage src="/images/portrait-nancy-baker.png" class="mb-8 h-32 w-full object-contain object-center" />
          <h3 class="mb-8 text-xl">
        ...
        <Card background="light" button-label="Read their story" button-link="https://doc.anytype.io/d/faqs/we-are-using-ipfs.-what-is-that" center>
          <UnLazyImage src="/images/logo-anytype.png" class="mb-8 h-32 w-full object-contain object-center" />
          <h3 class="mb-8 text-xl">
    ...
    <PageSection>
      ...
      <Grid>
        <Card center>
          <UnLazyImage src="/images/constellation-open.svg" class="mx-auto mb-8" />
        ...
        <Card center>
          <UnLazyImage src="/images/constellation-verifiable.svg" class="mx-auto mb-8" />
          <h3 class="mb-4 text-2xl text-brand-teal-dark">
            Verifiable
          </h3>
          <p class="mb-8 text-xl">
        ...
        <Card center>
          <UnLazyImage src="/images/constellation-resilient.svg" class="mx-auto mb-8" />
          <h3 class="mb-4 text-2xl text-brand-teal-dark">
            Resilient
          </h3>
          <p class="mb-8 text-xl">
